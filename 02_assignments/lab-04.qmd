...
4.  Which team has been to the playoffs the most times?
...
![](images/common-aesthetics-1.png){fig-alt = "Illustrations of common aesthetic choices, including the position of the x and y axis, the shape of points, the size of points, color, line width, and line type, like solid, dotted, etc."}
...
![](ggplot_shapes.png){fig-alt = "A chart with the 25 different options for point shapes. For example, 0 is a square, 1 is a circle, and 2 is a triangle."}
...
Here are the color palettes available in the viridis package:
[](viridis_colors.png){fig-alt = "The colors available in the viridis package."}
